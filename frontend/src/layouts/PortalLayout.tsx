...
export type PortalPage = 'dashboard' | 'properties' | 'tenants' | 'tokens' | 'usage' | 'system' | 'settings' | 'users' | 'transactions' | 'history' | 'predictions' | 'budget' | 'intelligence' | 'pools' | 'insights' | 'savings' | 'merchant' | 'offline' | 'meter' | 'support' | 'alerts';
