...
export type PortalPage = 'dashboard' | 'properties' | 'tenants' | 'tokens' | 'usage' | 'system' | 'settings' | 'users' | 'transactions' | 'history' | 'predictions' | 'budget' | 'intelligence' | 'pools' | 'insights' | 'meter' | 'support' | 'alerts';
