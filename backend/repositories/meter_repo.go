...
func (r *MeterRepo) Create(m *models.Meter) error {
	_, err := r.db.Exec(`
...
func (r *MeterRepo) GetByUserID(userID string) (*models.Meter, error) {
	m := &models.Meter{}
	err := r.db.QueryRow(`
...
func (r *MeterRepo) UpdateSettings(meterID string, s *models.MeterSettings) error {
	_, err := r.db.Exec(`
...
func (r *MeterRepo) InsertUsageHistory(h *models.UsageHistory) error {
	_, err := r.db.Exec(
...
func (r *MeterRepo) GetRecentHistory(meterID string, limit int) ([]*models.UsageHistory, error) {
	rows, err := r.db.Query(`
	...
	var hist []*models.UsageHistory
	for rows.Next() {
		h := &models.UsageHistory{}
